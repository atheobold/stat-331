...
better understand what the "normality" and "equal variance" conditions mean.
...
why we can use the same value of $\sigma$ when generating errors. 
...
```{r}
new_data %>% 
  ggplot(aes(y = predict_length, x = bill_length_mm)) + 
  geom_point() + 
