...
`r emo::ji("play button")` Watch Videos: __ minutes
  ...
  * `r emo::ji("link")` Link to **all** Slides from Videos: [here (will post with videos)]()

`r emo::ji("book")` Readings:  minutes   

`r emo::ji("computer")` Activities: 45 minutes  
  
`r emo::ji("check")` Check-ins: 2 (combined in 1 check-in in Canvas)

---

## Review: Statistical Distributions

`r emo::ji("play button")` [Required Video -- A Review of the Normal Distribution (will post Monday by noon)]()
...
`r emo::ji("play button")` [Required Video -- Simulating Data in R (will post Monday by noon)]()
...
**Question 2:** Explain in one sentence why

```
dnorm(2, mean = 0, sd = 1)
1 - dnorm(2, mean = 0, sd = 1)
```
add up to 1.
