...
**Question 1:** Explain in one sentence why each of the functions above produced
the output you obtained. 

**Question 4:** Explain in one sentence why `rnorm(mean = 0, sd = 1)` gives an
error.

**Question 5:** Explain in one sentence why
```
dnorm(2, mean = 0, sd = 1)
```
will always produce a number between 0 and 1. 
...
run if you forget or reset the seed in between each line of code!
