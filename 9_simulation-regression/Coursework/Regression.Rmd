...
`r emo::ji("play")` Watch Videos: 15 minutes
...
`r emo::ji("play")` [Recommended Video -- Simple Linear Regression (will post Sunday by 5pm)]()


## Assumptions of Linear Regression

`r emo::ji("play")` [Recommended Video -- Regression Assumptions (will post Sunday by 5pm)]()
...
a) Make a plot illustrating `my_model_2`.  
