...
b)  What happens if you switch the order of `bill_length_mm` and `bill_depth_mm` in the `lm()` formula?
...
b)  Penguin Mopsy has a bill that is 5mm deeper than Penguin Gidget. How much shorter do you expect Penguin Mopsy's bill to be?
...
c)  Do the three species of penguin have the same bill shape (i.e., the relationship between length and depth)? How do you know?
