...
For this Challenge you will explore how to generate nice looking tables for HTML documents. There are many packages for generating tables, but the tools we discussed in class are:
...
If you would like a refresher on these tools, I would encourage you to look back at the slides from class!

### Part 1 -- Formatting Basic Tables

Create nice, basic HTML tables for [**every**]{.underline} table in this lab using either:

- the `kable()` function from the [kable package](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html) 

**OR**

- the `gt()` function from the [gt package](https://gt.rstudio.com/index.html) to 
...
Spice up **at least one** of your tables using either the [kableExtra package](https://bookdown.org/yihui/rmarkdown-cookbook/kableextra.html) or add-on functions from the [dt package](https://gt.rstudio.com/). 
...
### Part 3 - Interactive Tables

Use the `datatable()` function from the DT package to include an interactive preview of the dataset **at the beginning of your report**.