...
The **entire** final project is due on **Sunday, June 6th**. Since nothing is 
due until the end of the course, it is your group's responsibility to ensure 
that you are staying on top of the work. You will be given class time to 
complete the project, both this Thursday (5/27) and next week. I am also 
...
## Option A: Animating a Plot [+10 Challenge Points]
...
This project will involve more learning-on-your-own and frustrating
troubleshooting than any of the others.

As a reward (in addition to bonus points!), you will have a personal website
that you have built.

The site should showcase in some way the data analysis you performed -- probably
in the form of a small blog post on the site.  This analysis can be less formal,
and less complex, than the written report.  
