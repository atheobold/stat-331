...
Create **three** visualizations exploring the following:
...
3. How this relationship (from #1) differs by region 
...
*Hint: You should use the `kable()` function from the [kable package](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html), and 
think about adding some extra styling features with the[kableExtra package](https://bookdown.org/yihui/rmarkdown-cookbook/kableextra.html)*