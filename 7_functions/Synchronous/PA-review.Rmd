...
<!-- Show unannotated function composition, then progress the slides -->

<!-- Give example with and without default argument -->
...
<!-- Big picture for why this is important -->
...
<!-- lead with motivating example for returning errors -->

<!-- discuss relationship between stop() and return() -- only relevant in function environments -->
...
<!-- Add slide / exercise on truth tables  -->

<!-- Live code conditions -->
...
<!-- Give motivating example of missing value coding -->

<!-- Show screenshot of missing value df -->
...
<!-- Note that there is no return in this function -->
...
<!-- talk about where there are three return() statements -->
...
<!-- Add slide on debugging strategies! -->

---

<!-- Make slides on key points for PA -->

---

Add summary slides at end 
