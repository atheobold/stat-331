...
other value in the vector. **Do not** use a `for()` loop to do this! Accomplish
...
Write a function called `shorten()` which takes a vector, drops the values of 
the vector if the cumulative sum is greater than a provided number, and returns
