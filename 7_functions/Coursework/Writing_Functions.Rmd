...
`r emo::ji("play button")` [Required Video: Why write a function? -- 5 minutes](http://somup.com/crh6eXFmMK)

`r emo::ji("play button")` [Required Video: Components of a function -- 10 minutes](http://somup.com/crh6euFmNj)

`r emo::ji("play button")` [Required Video: More about function arguments -- 12 minutes](http://somup.com/crh6F9FJY9)

`r emo::ji("play button")` [Required Video: More about function returns -- 9 minutes](http://somup.com/crh6q6FJ3o)

`r emo::ji("play button")` [Required Video: Function environments -- 6 minutes ](http://somup.com/crh6eBFmNK)
...
_**Hint:**_ You should start by using the function `dplyr::rownames_to_column()`,
