...
`r emo::ji("play button")` [Required Video: More about function arguments -- posted by May 10 at noon]()

`r emo::ji("play button")` [Required Video: More about function returns  -- posted by May 10 at noon]()
