...
<center>**Output both pieces of information in *one* table!**</center>
...
*Note:* I advise against using functions like `mutate_at()`, which
...
*Hint:* If you are struggling with the structure of your function, I would suggest reading the [Mutating Function](https://r4ds.hadley.nz/functions.html#mutate-functions) section from the second edition of R for Data Science.
...
Your Challenge submission should be ***separate*** from your Lab submission, meaning I should see only Parts 1-3 associated with the
Challenge included in your submission. 