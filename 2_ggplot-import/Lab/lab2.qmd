...
**11. Use the `color` argument in `geom_jitter()` to change the color of the points.** *You are welcome to use whatever color you wish, some of my favorites are: tomato, cadetblue, and darkseagreen* :)
