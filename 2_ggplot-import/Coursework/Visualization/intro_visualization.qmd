...
Now that we've refreshed how to work with different types of objects in R, let's start visualizing!

> "The simple graph has brought more information to the data analysist's mind than any other device." -- John Tukey
...
This week we will be taking a deep dive into data visualization, using the **ggplot2** package. The ggplot2 package is included in the **tidyverse** package that you have already downloaded! To load in the ggplot2 package, you will either need to run the code to load in the entire tidyverse package *or* load in the ggplot2 package directly.
...
This coursework will walk you through the different sections of Chapter Three in *R for Data Science*.

`r emo::ji("book")` [Required Reading: Data Visualisation](https://r4ds.hadley.nz/data-visualize.html).
...
**Question 1** -- With the `mpg` dataset, make a scatterplot of `hwy` versus `cty`. Which of these correctly describe the relationship seen in the plot?
