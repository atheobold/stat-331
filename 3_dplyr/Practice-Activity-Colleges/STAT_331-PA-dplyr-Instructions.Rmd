...
* Include package names in your search terms.  For example, "bar plot in ggplot"
is a better search than "bar plot in R".
...
(Note that the data loading function `read_csv` will give you an outpouring of
helpful information about the dataset.  If you do not see the word "error",
