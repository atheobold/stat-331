...
in this study.  You do not need to discuss these plots, but make sure they are appropriate to the data types and have informative titles and axis labels.
...
differentiates the groups.  That is, which genre had much higher average
(mean or median) score in one group than the other.
...
Helpful functions: `select()`, `group_by()`, `summarize_at()`, `which.max()`
...
Aubrey hopes that his songs will be percieved as authentically hiphop. Although
