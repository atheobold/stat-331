...
It is fairly common for researchers to collapse ethnic or racial categories similar to what you just did. What are some issues with representing the data in this way?
...
Your challenge should be submitted as a separate file, not included at the bottom of your Lab 3 file. Please submit both a rendered HTML file **and** the source code (Quarto document).
