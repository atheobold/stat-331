...
`r emo::ji("play button")` [Required Video: `arrange()` -- 7 minutes](http://somup.com/crfl2abSgF)

$\hspace{0.25in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/arrange.html)

`r emo::ji("play button")` [Required Video: `summarize()`-- 8 minutes](http://somup.com/crflFLbWom)
...
`r emo::ji("play button")` [Required Video: The pipe operator -- ]()

$\hspace{0.25in}$ `r emo::ji("link")` [Link to Slides](Slides/extensions/pipe.html)

`r emo::ji("play button")` [Required Video: Extending the pipe -- ]()
