...
$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/packages.html)
...
$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/data_types.html)

`r emo::ji("play button")` [Required Video: A Bit More on Object Structures -- 8 minutes](http://somup.com/crf6YVb9oH)

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/object_structure.html)
...
`r emo::ji("play button")` [Required Video: `filter()`](http://somup.com/crflVqbRaR)

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/filter.html)

`r emo::ji("play button")` [Required Video: `select()` -- will be posted 4/11 by 9pm]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/select.html)

`r emo::ji("play button")` [Required Video: `arrange()` -- will be posted 4/11 by 9pm]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/arrange.html)

`r emo::ji("play button")` [Required Video: `mutate()` -- will be posted 4/12 by 9am]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/mutate.html)

`r emo::ji("play button")` [Required Video: `summarize()`-- will be posted 4/12 by 9am]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/summarize.html)

`r emo::ji("play button")` [Required Video: `group_by()` -- will be posted 4/11 by 9pm]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/verbs/group_by.html)
...
$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/extensions/pipe.html)

`r emo::ji("play button")` [Required Video: Extending the pipe -- will be posted 4/12 by 9am]()

$\hspace{1in}$ `r emo::ji("link")` [Link to Slides](Slides/extensions/extend_pipe.html)
