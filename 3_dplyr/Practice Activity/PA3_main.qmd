...
## Access the PA3 Quarto file

First, the individual appointed the "Reporter" for the team should [access the Practice Activity through through Posit Cloud](https://posit.cloud/content/5280164).

Once you have the Practice Activity open, click on the `PA3_student.qmd` file to open the Practice Activity 3 Quarto file. 
