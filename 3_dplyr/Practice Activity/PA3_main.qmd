...
First, download the template Quarto file [here (link to GitHub)](https://github.com/atheobold/stat-331/blob/main/3_dplyr/Practice-Activity-Colleges/PA3_student.qmd):

Next, save the file in your Stat 331 / 531 folder -- this should be in a Week 3 or a Practice Activity subfolder!
