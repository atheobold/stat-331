...
::: {.callout-note}
The name of the `sheet` must be passed in as a string (in quotations)!
:::
...
::: {.callout-tip}
Notice how you are mutating *every* variable in the dataset? That sounds like 
a great place for `across()`! Additionally, you might find the `na_if()`
function helpful. 
:::
...
::: {.callout-tip}
Again, it looks like you want to use the **same** function *across* a set of 
variables. What function might be helpful???
:::
