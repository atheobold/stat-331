...
military <- read_xlsx(here::here("4_tidyr-joins", "Practice Activity", 
...
```{r, message = FALSE}
cont_region <- read_xlsx(here::here("4_tidyr-joins", "Practice Activity", 
                                 "data", "gov_spending_per_capita.xlsx"), 
...
and immediately piping it into the `filter()` function to remove the observations
I don't want. Fun! 
