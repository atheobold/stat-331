...
**5.** Which metro area regions sold the most total avocados? Plot density ridges of the total volume for **only the five regions** with the highest averages for the `Total Volume` variable.
