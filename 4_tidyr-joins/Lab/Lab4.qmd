...
**Every member of the group must submit an .html and .Rmd file to the Lab 4
assignment portal!**
...
* Making your code readable and nicely formatted. (You **will** get feedback 
from you peers on code style.)
...
__0.__ Create a Quarto file, load the data, and declare your package
dependencies. 
...
to make an argument about the relationship between house prices and avocado
prices/sales.  Support your argument with a plot.
