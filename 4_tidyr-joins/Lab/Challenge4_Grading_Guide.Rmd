...
- Acquire a dataset on CA housing prices -- 3 points
  ...
  * Obtain a dataset with multiple values for each year -- 3 points

- Joining the datasets -- 2 points

# Making Your Case

- Produce a visualization -- 3 points

  * Visualize the relationship between housing prices and avocado prices across
  different cities and different years on the *same* plot -- 3 points  
  * Visualize the relationship between housing prices and avocado prices across
  different cities and different years on *different* plots -- 2 points
