...
`r emo::ji("movie")` [Required Video -- Working with Factors Using forcats](https://www.youtube.com/embed/dAiSYli7tVg)
...
`r emo::ji("movie")` [Required Video -- Strings Strings](https://www.youtube.com/embed/Oo_MtXwpi2Q)
...
`r emo::ji("movie")` [Required Video -- Working with Dates Using lubridate](https://www.youtube.com/embed/SEPjN2AJqbo)
