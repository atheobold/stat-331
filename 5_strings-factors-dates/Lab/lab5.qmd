...
::: callout-note
Your plot should have **no** y-axis label, only a plot title and x-axis label!
:::
...
**5. Reorder the colors in the legend, so the label order matches the order of the lines in the plot.**
...
::: callout-note
Your plot should have **no** y-axis label! You are permitted to have a plot title, x-axis label, and legend title.
:::
