...
*If you already have `R` downloaded, please follow these steps anyways, to make
sure you have the most recent version of `R`.* **Do not ignore these
instructions.** If you neglect to update your version of R, you may find that 
updating a package will make it so your code will not run. 
...
You **do not** need an update if your RStudio logo looks like this: <img src='../../../Images/rstudio_images/rs_icon_new.png' height='25' width='50'>

You **do** need an update if your RStudio logo looks like this: <img src='../../../Images/rstudio_images/rs_icon_old.png' height='25' width='25'>
...
2. "I can't get R to open!"

3. "Can I send you my RStudio so you can check out if my code is correct? "
