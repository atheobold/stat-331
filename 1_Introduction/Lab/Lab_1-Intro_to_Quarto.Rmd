...
2.  Specify in the code chunk options that your plot of the `pressure`
    dataset (\@sec-creating-a-plot) should be center aligned.

3.  Specify a figure caption in the above code chunk
    (\@sec-creating-a-plot).

4.  In the code chunk created in
    (\@sec-creating-and-discussing-visualizations), specify the figures
    should be printed side-by-side (in two columns).
