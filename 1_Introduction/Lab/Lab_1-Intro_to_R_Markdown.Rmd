...
**This Lab 1 option is for those who wish to create an R Markdown document.**
...
5. Save the R Markdown file as "lab1" in your "Week 1" or "Labs" folder. You can 
...
### Styling R Markdown Documents

There are infinitely many ways to make R Markdown documents look fancier. In
fact, that's how I create all the coursework and assignment documents for this
class!
