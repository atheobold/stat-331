---
title: "Welcome to Stat 331 & R Review"
date: "March 30, 2021"
...
- The `c()` function binds a list of numbers or letters into a vector
...
.large[Extracting Elements from a Matrix]
...
- Dimensions are noted by `[rows, columns]`
  * Extract rows using: `[rows, ]`
  * Extract columns using: `[ , columns]`

.hand[How would you extract the second row of `mat`?]
