...
[Required Video: Welcome to Stat 331 from Dr. Theobold](http://somup.com/creubsbzlJ)
...
This is a *synchronous* online course, scheduled to meet on Tuesdays and Thursdays for 2 hours at a time. 

We **will** be meeting every Tuesday and Thursday this quarter, and attendance is expected. 

We will be using Zoom for our course meetings, and Discord for our out of class meetings. 
...
Join the [Stat 331 Server](https://discord.gg/UTrnrKRUFd) to start experimenting with the interface.
...
[Required Video: Class Structure](https://www.youtube.com/watch?v=yzNLr0fDNcg)
...
As part of your "in-class" work, each week you will have short practice tasks to complete which tie the concepts from the reading and lectures together.  You should plan for these to take you 1-3 hours per week.
...
The synchronous meetings on Tuesdays will have 1-hour dedicated to working on these practice activities, where you will work in your team in a breakout room. This allows for you to have the ability to "call me into your room," should any questions / issues arise. 

### Lab Assignments

*Due Sundays at midnight*

Aside from the Final Project and Exams, the majority of your grade in this class comes from Lab Assignments.  You should plan to spend a large amount of time outside of class (5-10 hours each week) completing your Lab Assignment.

Lab work is completed in **teams**. Please read the description of the team roles that will be circulated around. 
...
These challenges are worth 10% of your overall grade.
...
**Question 4:** Revisions will be required for questions not earning at least what score on lab assignments?

**Question 5:** If you complete ALL the Challenges, but you do not earn bonus
points on any of them, what will be your grade in this category?

**Question 4:** How will the midterm and final exams be administered?
...
[Link to Google Form](https://forms.gle/MQ9XTqwWNeDaVDjTA)
...
With this class being online, there will likely be a temptation to skip things,
multitask, and cut corners.  
...
In return for your efforts, I promise to choose required videos and readings 
...
For this reason, this course makes use of team-based learning. In the first week 
you will be placed into a team that will last for the first 5 weeks of the 
course. After the midterm, you will be given the option to join a new group or 
...
The class Discord server is a great way to get started.  We also hope you will
