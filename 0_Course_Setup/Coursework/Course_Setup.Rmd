...
In particular, course **office hours** are held via Discord.  Your professor
will be available for public questions, or one-on-one and small group chats by
text, voice, or video.

The office hours for this class are:

#### Tuesdays & Thursdays from 2 - 3pm **in-person**
#### Tuesdays & Thursdays from 3 - 4pm **on Discord**
...
Join the [Stat 331 Server](UPDATE LINK) to start experimenting with the
interface.
...
The course meetings on Mondays will have atleast 1-hour dedicated to working on
