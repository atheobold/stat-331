...
avocado <- read_csv(here::here("4-tidyr-joins", "Lab", "avocado.csv"))
...
the `region` variable.  Notice that the category `"LosAngeles"` is contained in `"California"`, which is contained in `"West"`, which is contained in 
