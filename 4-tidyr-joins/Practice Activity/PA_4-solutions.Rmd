...
Next, you'll notice that there are notes about the dataset in the first seven rows. 
Ugh! 
...
us the `Region` column of this dataset to filter out the names we don't want. 
...
dataset? Use their correct capitalizaton **and** punctutation! 
