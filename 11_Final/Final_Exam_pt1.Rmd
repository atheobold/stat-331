...
This exam is due by **5:00pm** on **Friday, March 18th**.
...
function can either return the dataframe with an adjusted version of the 
variable(s) supplied ***or*** a vector with the adjusted variable(s).
