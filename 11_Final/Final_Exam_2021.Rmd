...
This exam is due at **8:00am** on **Wednesday, June 9th**.
...
Which of the following functions will correctly carry out this process?
...
penguins %>% 
  map_dfc(vars(species, island, sex), na_df)
```
